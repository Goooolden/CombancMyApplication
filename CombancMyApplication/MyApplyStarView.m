...
@implementation MyApplyStarView
...
- (void)createDataAndUI {
    ...
    UIPanGestureRecognizer *panGesture = [[UIPanGestureRecognizer alloc]initWithTarget:self action:@selector(userTapRateView:)];
...
- (void)layoutSubviews {
    ...
    __weak MyApplyStarView *weakSelf = self;
